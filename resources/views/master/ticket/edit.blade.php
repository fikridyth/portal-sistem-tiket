...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('master.ticket.update', $ticket->id) }}" method="POST" class="form" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row mb-4">
                <div class="col">
                    <select class="form-select @error('id_event') is-invalid @enderror" id="id_event" name="id_event" data-control="select">
                        <option value="{{ $ticket->event->id }}">{{ $ticket->event->nama }}</option>
                ...
                <div class="col">
                    <div data-mdb-input-init class="form-outline">
                        <input type="text" id="nama" name="nama" value="{{ old('nama', $ticket->nama ?? null) }}"
            ...
            <div class="row mb-4">
                <div class="col">
                    <div data-mdb-input-init class="form-outline">
                        <input type="number" id="harga" name="harga" value="{{ old('harga', $ticket->harga ?? null) }}"
                ...
                <div class="col">
                    <div data-mdb-input-init class="form-outline">
                        <input type="number" id="kuota" name="kuota" value="{{ old('kuota', $ticket->kuota ?? null) }}"
                ...
                <div class="col">
                    <div data-mdb-input-init class="form-outline">
                        <textarea type="text" id="keterangan" name="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                            autocomplete="off" />{{ old('keterangan', $ticket->keterangan ?? null) }}</textarea>
